...
import com.kisankalyan.security.JwtAuthenticationFilter;
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers(HttpMethod.GET, "/api/queue/public/**").permitAll()
                .requestMatchers(HttpMethod.GET, "/api/stats/public/**").permitAll()
                // Farmer role endpoints
                .requestMatchers("/api/farmer/**").hasAnyRole("FARMER", "ADMIN")
                .requestMatchers("/api/bookings/**").hasAnyRole("FARMER", "OPERATOR", "ADMIN")
                // Operator role endpoints
                .requestMatchers("/api/operator/**").hasAnyRole("OPERATOR", "ADMIN")
                .requestMatchers("/api/procurement/**").hasAnyRole("OPERATOR", "ADMIN")
